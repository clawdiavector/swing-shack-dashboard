...
const BASE="/Users/fivefriday/.openclaw-instance2/workspace/swing-shack-dashboard";const DATA=path.join(BASE,"data");const A="live_action_auditor";const start=Date.now();
