...
const BASE="/Users/fivefriday/.openclaw-instance2/workspace/swing-shack-dashboard";const DATA=path.join(BASE,"data");const A="whatsapp_conversion_builder";const start=Date.now();
...
console.log("\n["+A+"] "+r.status+" ("+r.duration_ms+"ms)");if(errMsg)console.log("   ERROR: "+errMsg);
