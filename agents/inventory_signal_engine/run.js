...
const BASE="/Users/fivefriday/.openclaw-instance2/workspace/swing-shack-dashboard";const DATA=path.join(BASE,"data");const A="inventory_signal_engine";const start=Date.now();
