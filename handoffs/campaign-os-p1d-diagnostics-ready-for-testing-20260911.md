...
| Origin tip | `origin/feat/campaign-os-p1d-diagnostics` — run `git rev-parse origin/feat/campaign-os-p1d-diagnostics` (RFT handoff commit lands after code-complete) |
